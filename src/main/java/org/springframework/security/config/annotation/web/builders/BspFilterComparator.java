...
public class BspFilterComparator implements Comparator<Filter>, Serializable {
    private static final int INITIAL_ORDER = 100;
    private static final int ORDER_STEP = 100;
    private final Map<String, Integer> filterToOrder = new HashMap<>();

    BspFilterComparator() {
        BspFilterComparator.Step order = new BspFilterComparator.Step(INITIAL_ORDER, ORDER_STEP);
        ...
        filterToOrder.put(
                ...
                order.next());
        put(BspFormLoginAuthenticationFilter.class, order.next());
        put(ConcurrentSessionFilter.class, order.next());
        filterToOrder.put(
