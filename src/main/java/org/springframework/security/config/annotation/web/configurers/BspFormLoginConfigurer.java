...
import de.tmobile.bsp.security.spring.BspFormLoginAuthenticationFilter;


public class BspFormLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
        AbstractAuthenticationFilterConfigurer<H, BspFormLoginConfigurer<H>, BspFormLoginAuthenticationFilter> {
    /**
     * Creates a new instance
     * @see HttpSecurity#formLogin()
     */
    public BspFormLoginConfigurer() {
        super(new BspFormLoginAuthenticationFilter(), null);
     ...
     * {@link BspFormLoginAuthenticationFilter}:
     * </p>
     *
     * <ul>
     ...
     * "/login")
     * @return the {@link BspFormLoginConfigurer} for additional customization
     */
    @Override
    public BspFormLoginConfigurer<H> loginPage(String loginPage) {
     ...
     * @return the {@link BspFormLoginConfigurer} for additional customization
     */
    public BspFormLoginConfigurer<H> usernameParameter(String usernameParameter) {
     ...
     * @return the {@link BspFormLoginConfigurer} for additional customization
     */
    public BspFormLoginConfigurer<H> passwordParameter(String passwordParameter) {
     ...
     * @return the {@link BspFormLoginConfigurer} for additional customization
     */
    public BspFormLoginConfigurer<H> failureForwardUrl(String forwardUrl) {
     ...
     * @return the {@link BspFormLoginConfigurer} for additional customization
     */
    public BspFormLoginConfigurer<H> successForwardUrl(String forwardUrl) {
